...
<div class="invoice-area">
    <div class="invoice-wrapper">
        <div class="invoice-header">
            ...
            <h1 class="invoice-title" style="text-align:center;">Customer Invoice</h1>
        </div>
        <div class="invoice-details">
            <div class="invoice-details-flex">
                <div class="invoice-single-details">
                    @foreach($bookings as $booking)
                    <h2 class="invoice-details-title">Ship To: {{ $booking->customer_name }}</h2>
                    <ul class="details-list">
                        {{-- <li class="list">{{ $order->customerName }}</li> --}}
                        <li class="list">Email:{{ $booking->email }} </li>
                        <li class="list">Phone:{{ $booking->phone_number }} </li>
