					...
					<form method="post" action="{{route('sponsor.store')}}" enctype="multipart/form-data">
						...
						<label class="col-sm-12 col-md-2 col-form-label">Company Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter company Name" name="company_name" value="{{old('company_name')}}">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Event Location</label>
                                <div class="col-sm-12 col-md-10">
                                    <input class="form-control" type="text" placeholder="Enter Company Location" name="location" value="{{old('location')}}">
                                </div>
                            </div>
