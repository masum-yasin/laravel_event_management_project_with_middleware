...
@section('content')
<section class="banner pt-10 pb-0 overflow-hidden" style="background-image:url(frontend/assets/images/banner_img.png);">
    <div class="container">
        <div class="banner-in pt-6">
            <div class="row align-items-end">
                ...
                <div class="col-lg-5">
                    <div class="banner-image" style="background-image:url(frontend/assets/images/manbg.png);">
...
<!-- coming counter Ends -->
 ...
 <!-- about-us starts -->
 <section class="about-us about-features pt-12 pb-8" style="background-image:url(frontend/assets/images/testimonial-1.png);">
    <div class="container">
        <div class="about-image-box">
            <div class="row d-flex align-items-center justify-content-between">
                <div class="col-lg-7 pe-lg-4">
                    <div class="about-features" style="background-image:url(frontend/assets/images/contentbg.png);">
                ...
                <div class="col-lg-7 ps-4">
                    <div class="about-features" style="background-image:url(frontend/assets/images/contentbg.png);">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <img src="frontend/assets/images/about/busi-1.jpg" alt="" class="mb-4">
            ...
            <div class="about-image-box bg-white mb-4">
                ...
                <div class="row">
                    <div class="col-lg-3 d-flex">
                        <div class="about-content text-center text-lg-start p-4 py-8 w-100">
                            <img src="{{asset('uploads/'.$item->image)}}" alt="Image" width="200px" height="200px">
                        </div>
                    </div>
...
<!-- our teams starts -->
<section class="event-team" style="background-image: url(frontend/assets/images/manbg.png);">
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-6">
                    <div class="pricing-item text-center p-5 bg-theme1 position-relative">
                        <div class="pricing-top" style="background-image: url(frontend/assets/images/pricebox-topblue.png);"></div>
